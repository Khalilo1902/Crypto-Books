...
const TableComponent = () => {
  ...
  const displayCoinsId = useSelector((state: RootState) =>
    ...
    "
            >
              <td className="py-4 flex items-center uppercase">
                ...
                <img
                  className="w-[1.2rem] h-[1.2rem] mx-1.5"
                  src={displayCoinsId.image}
                  alt={displayCoinsId.name}
                />
              ...
              <td className="py-4">
                {displayCoinsId.market_cap_change_percentage_24h}%
              </td>
              <td
                className={
                  displayCoinsId.price_change_percentage_1h_in_currency > 0
                    ? "text-green py-4"
                    : "text-red py-4"
                }
              >
                {displayCoinsId.price_change_percentage_1h_in_currency.toFixed(
                  2
                )}
              </td>
              <td
                className={
                  displayCoinsId.price_change_percentage_24h_in_currency > 0
                    ? "text-green py-4"
                    : "text-red py-4"
                }
              >
                {displayCoinsId.price_change_percentage_24h_in_currency.toFixed(
                  2
                )}
              </td>
              <td
                className={
                  displayCoinsId.price_change_percentage_7d_in_currency > 0
                    ? "text-green py-4"
                    : "text-red py-4"
                }
              >
                {displayCoinsId.price_change_percentage_7d_in_currency.toFixed(
                  2
                )}
              </td>
            </tr>
